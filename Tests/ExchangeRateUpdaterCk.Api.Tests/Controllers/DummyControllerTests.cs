using ExchangeRateUpdaterCk.Api.DTOs.Requests.Dummy;
using ExchangeRateUpdaterCk.Api.DTOs.Responses.Dummy;

namespace ExchangeRateUpdaterCk.Api.Tests.Controllers;
